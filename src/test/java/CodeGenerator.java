...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/lottery";
...
//        genCode("lottery_award","award_id");
//        genCode("lottery_record","record_id");
        genCode("lottery_user","user_id");
